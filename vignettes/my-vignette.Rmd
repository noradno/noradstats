...
Use the read_aiddata() function to import statsys data to R. The default path is to read the following path: "Norad-Avd-Kunnskap - Statistikk og analyse/06. Statistikkdatabaser/4. CSV/statsys_ten.csv"

```{r, eval=FALSE}
# Read statsys data into a data frame
df_statsys_ten <- read_aiddata()
...
```{r, eval = FALSE}
# Add basic columns
df_statsys_ten <- add_cols_basic(df_statsys_ten)
