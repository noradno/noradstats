  ...
  data  |>
    ...
    dplyr::mutate(
      target_area_no = dplyr::case_when(
        .data$`Target area` == "Economic infrastructure and services" ~ paste0(
        ...
        .data$`Target area` == "Environment and energy" ~ paste0(
          "Milj",
          stringi::stri_unescape_unicode("\\u00f8"),
          " og energi"
        ),
        ...
        .data$`Target area` == "Multilateral" ~ paste0(
    ...
    dplyr::mutate(
      income_category_no = dplyr::case_when(
        .data$`Income category` == "Upper Middle-Income Countries" ~ paste0("H", stringi::stri_unescape_unicode("\\u00f8"), "yere mellominntektsland"),
        .data$`Income category` == "Lower Middle-Income Countries" ~ "Lavere mellominntektsland",
        .data$`Income category` == "Low-Income Countries " ~ "Lavinntektsland",
        .data$`Income category` == "Least Developed Countries" ~ "Minst utviklede land",
        .data$`Income category` == "Unspecified" ~ "Uspesifisert"
      )
    )
}
